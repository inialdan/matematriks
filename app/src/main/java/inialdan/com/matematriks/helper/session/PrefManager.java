package inialdan.com.matematriks.helper.session;
...
public class PrefManager {
    ...
    public static final String SCORE_BELAJAR_ORDO_MATRIKS = "belajar_ordo_matriks";
    ...
    public String getScoreBelajarOrdoMatriks(){
        return pref.getString(SCORE_BELAJAR_ORDO_MATRIKS, "");
    }
    ...
    public String getLastScore(){
        return pref.getString(SCORE_LAST, "");
    }

    public String getScoreEssay(){
        return pref.getString(SCORE_ESSAY, "");
    }
